...
class impuestos_mdl extends MY_Model {
	...
	public function __construct() {
		...
		$this->primary_key = 'impuesto.impuesto_id';
		$this->select_fields = "
		SQL_CALC_FOUND_ROWS *";
		$this->order_by = 'impuesto_id, impuesto_nombre';
	}

	public function validate() {
		$this->form_validation->set_rules('impuesto_nombre', "Nombre de impuesto", 'required');
		$this->form_validation->set_rules('impuesto_porcentaje', "Porcentaje de impuesto", 'decimal');
