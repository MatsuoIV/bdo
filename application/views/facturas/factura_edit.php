...
<script type="text/javascript">
	$(function(){
		var append_to_clone = ' <a class="remove" href="#" onclick="$(this).parent().remove(); return false">Eliminar</a>';
...
<div class="grid_10" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<?php echo 'Factura '.$factura->factura_numero; ?>
			<input type="submit" name="btn_add_payment" style="float: right; margin-top: 10px; margin-right: 10px;" value="Ingresar pago" />	
		</h3>
		<?php $this->load->view('panel/system_messages'); ?>
